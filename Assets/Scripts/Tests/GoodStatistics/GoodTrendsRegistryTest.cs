...
namespace Tests.GoodStatistics {
  public class GoodTrendsRegistryTest {
    ...
    public void ShouldAnalyzeSample() {
      ...
      // When
      goodSampleRegistry.AddSample(
          BreadId, new(ResourceCount.Create(10, 10, 10, 10, 0, 0, 0, 0), 0));
    ...
    public void ShouldNotAnalyzeSampleWithoutStockpile() {
      ...
      // When
      goodSampleRegistry.AddSample(BreadId, new(ResourceCount.Create(0, 10, 0, 10, 0, 0, 0, 0), 0));
    ...
    public void ShouldNotAnalyzeSampleWithLowStockpile() {
      ...
      // When
      goodSampleRegistry.AddSample(BreadId, new(ResourceCount.Create(5, 0, 5, 0, 0, 0, 0, 0), 0));
    ...
    public void ShouldAnalyzeSampleWithEnoughStockpile() {
      ...
      // When
      goodSampleRegistry.AddSample(BreadId, new(ResourceCount.Create(0, 0, 10, 0, 0, 0, 0, 0), 0));
